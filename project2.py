...
def apply_median_filter():
    if img:
        show_image(img.filter(ImageFilter.MedianFilter(size=3)), panel_filtered)
...
btn_open.grid(row=5, column=0, padx=10)
